...
def _get_records(module_id, page=1, page_size=20, search=None, search_field=None):
    ...
    if search and search_field:
        ...
        return crud.records.query_records(QueryRecordsRequest(context=ctx, query=query))
    return crud.records.list_records(ListRecordsRequest(
...
def _delete_record(module_id, record_id):
    ...
    return crud.records.delete_record(DeleteRecordRequest(
